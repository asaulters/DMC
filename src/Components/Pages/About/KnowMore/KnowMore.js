        ...
        <div className={classes.dropDownDiv}>
            ...
            <div 
                ...
                ><b>{extend2? <b>- </b> : <b>&#43; </b>}</b> 
                 Cost Factors</div>
                {extend2 &&(
                    <p>As renovation contractors , our practice is always to listen to our clients closely enough to understand what they need and to tailor our recommendations as precisely as possible. This eliminates unnecessary cost factors and allows them to stick to their planned renovation budget.<br/><br/> We look carefully for economies and ways the client can reduce costs, and explain in detail what the various options are and how they affect the final price.</p>
                )}    
            <div 
                className={classes.dropHeading}
